...
public class Fragment4_Now_Views_Task_For_Complete extends Fragment {
   ...
   private BottomNavigationItemView bottomNavigationПринудительныйОбмен;
    ...
    public void onDestroy() {
        super.onDestroy();
        try{
                Log.d(this.getClass().getName(), " отработоатл new subClassBuccessLogin_главныйКлассБизнесЛогикиФрагмент4ЗаполенияЗадачиДляСозданияНовойЗадачи onDestroyView  " );
                //service_for_task_для_задания_сменаСатуса.onUnbind(new Intent());
                // TODO: 26.06.2022 удаляем биндинг службы
                getContext().unbindService(subClassBuccessLogin_главныйКлассБизнесЛогикиФрагмент4ЗаполенияЗадачиДляСозданияНовойЗадачи.connectionДляСменыСтатусаЗадач);
                /////////////
    ...
    public void onResume() {
        ...
        try {
            ...
            class_generation_sendBroadcastReceiver_and_firebase_oneSignal=new Class_Generation_SendBroadcastReceiver_And_Firebase_OneSignal(getContext());
